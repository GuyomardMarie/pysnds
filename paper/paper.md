...
![Main SNDS tables used in the provided package. (8*) refers to 8 key variables: DCT_ORD_NUM, FLX_DIS_DTD, FLX_EMT_NUM, FLX_EMT_ORD, FLX_TRT_DTD, ORG_CLE_NUM, PRS_ORD_NUM, REM_TYP_AFF.](Schema_SNDS.png){width=1600px}

Several functionalities of the class locate medical codes of interest in different databases (see Figure 1) related to:
...
![Illustration of the furnished dictionary.](BC_medical_codes.png){width=1000px}
...
The Figure 3 is produced by these functionalities and illustrates the different caracterizations provided by this class on the simulated dataset[^1].
